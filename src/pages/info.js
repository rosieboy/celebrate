...
//import dogIllustration from "../images/IMG_1964.jpeg";
        ...
        <div className="bg-white py-10 sm:py-12 lg:py-16">
            <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <h2 className="mt-2 max-w-3xl text-2xl font-semibold font-display text-gray-900 sm:text-3xl lg:max-w-4xl lg:text-4xl lg:mx-auto lg:text-center ">
                      Vi promenerar oavsett väder, och sysselsätter under vägs med lite hyss.
                    </h2>
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="mt-1 max-w-xl text-base text-gray-600 lg:mt-2">
                                       Vi har gömt lite saker längs vägen, en sorts "geo-cache-light". Vi tänker att vi är ute och håller lite avstånd till varandra så uppfyller vi FHM:s alla krav.
                                      </p>
                        </div>
                    </div>
                    <div className="flex items-start">
